...
print "original   :", hdlc._repr(p1)
print "checksummed:", hdlc._repr(p2)
print "escapedelim:", hdlc._repr(p3)

#np = hdlc.HdlcChecksummed()
#np.add("")
...
class HdlcCRC(HdlcChecksummed):

    def __init__(self):
        super(HdlcCRC, self).__init__()
